...
impl DojoBuiltinRunner {
    pub fn new(ratio: Option<u32>, included: bool) -> DojoBuiltinRunner {
        DojoBuiltinRunner {
            ratio,
            base: 0,
            stop_ptr: None,
...
//         let builtin = DojoBuiltinRunner::<RC_N_PARTS_STANDARD>::new(Some(10), true);
...
//             DojoBuiltinRunner::<RC_N_PARTS_STANDARD>::new(Some(10), true).into();
...
//         let mut builtin: BuiltinRunner =
//             DojoBuiltinRunner::<RC_N_PARTS_STANDARD>::new(Some(10), false).into();
...
//         let mut builtin = DojoBuiltinRunner::<RC_N_PARTS_STANDARD>::new(Some(8), true);
...
//     #[cfg_attr(target_arch = "wasm32", wasm_bindgen_test)]
//     fn test_base() {
//         let builtin = DojoBuiltinRunner::<RC_N_PARTS_STANDARD>::new(Some(8), true);
//         assert_eq!(builtin.base(), 0);
//     }
...
//         let builtin = BuiltinRunner::RangeCheck(DojoBuiltinRunner::<RC_N_PARTS_STANDARD>::new(
//             Some(256),
//             true,
//         ));
//         let vm = vm!();
...
//             DojoBuiltinRunner::<RC_N_PARTS_STANDARD>::new(Some(8), true).into();
//         let mut vm = vm!();
...
//         let builtin: BuiltinRunner =
//             DojoBuiltinRunner::<RC_N_PARTS_STANDARD>::new(None, true).into();
